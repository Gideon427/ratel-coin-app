...
export default function Page() {
  ...
  return (
    <>
      ...
      <p className="text-sm text-gray-500">Internal transfer activity from user wallet records.</p>
      <div className="mt-6 rounded-lg bg-white p-6 shadow-sm border border-gray-100">
        <p className="text-gray-600">Transfer count: {stats.totalTransfers}</p>
      </div>
    </>
  );
}
